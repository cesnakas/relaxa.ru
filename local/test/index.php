...
/*
$APPLICATION->AddHeadScript(SITE_DIR.'bitrix/templates/dresscodeV2_new/js/jquery.js');
$APPLICATION->SetAdditionalCSS(SITE_DIR.'bitrix/templates/dresscodeV2_new/js/fancybox/jquery.fancybox.css');
$APPLICATION->SetAdditionalCSS(SITE_DIR.'bitrix/templates/dresscodeV2_new/js/fancybox/jquery.fancybox.min.css');
$APPLICATION->AddHeadScript(SITE_DIR.'bitrix/templates/dresscodeV2_new/js/fancybox/jquery.fancybox.min.js');
// ...
$APPLICATION->SetAdditionalCSS(SITE_DIR.'assets/js/fancybox/jquery.fancybox.min.css');
$APPLICATION->AddHeadScript(SITE_DIR.'assets/js/fancybox/jquery.fancybox.min.js');
// ...
$APPLICATION->SetAdditionalCSS(SITE_DIR.'bitrix/templates/dresscodeV2/css/prefix-new/main.css');
$APPLICATION->SetAdditionalCSS(SITE_DIR.'assets/css/style.css');
// ...
