        ...
        <div class="p-card">
            <div class="p-card__botomfix mob-visible">
                <div class="p-botomfix">
                    ...
                    <?} else {?>
                        <?if($arResult['CATALOG_QUANTITY'] && $arResult['CATALOG_QUANTITY'] > 0 && empty($arResult['PROPERTIES']['STATUS_OUT']['VALUE'])) {
                            ?>
                        ...
                        <span class="p-botomfix__buyleft">
                            ...
                            <? endif; ?>
                            <?
                        } elseif($arResult['CATALOG_QUANTITY'] == 0 && empty($arResult['PROPERTIES']['STATUS_OUT']['VALUE'])) {
                            ?>
                            <?
                ...
                <div class="wrapper">
                    ...
                    <?} else {?>
                        <?if($arResult['CATALOG_QUANTITY'] && $arResult['CATALOG_QUANTITY'] > 0 && empty($arResult['PROPERTIES']['STATUS_OUT']['VALUE'])) {
                            ...
                            ?>
                            <span class="p-carddes__nal p-prods__nal-snyat mob-visible">Нет в наличии</span>
                            <?
                            ...
                            ?>
                            <span class="p-carddes__nal p-prods__nal-no mob-visible">Доступен предзаказ</span>
                            <?
                        }?>
                    <?}?>
                </div>
                        ...
                        <div class="p-cardslider">
                                <div class="p-cardslider__tag">
									...
									<?if(empty($arResult["PROPERTIES"]["STATUS_OUT"]["VALUE"])) {?>
                                        ...
                                        <?} elseif(!empty($arResult["PROPERTIES"]["STATUS_OUT"]["VALUE"])){?>
                                            <span class="p-cardslider__new" style="background-color: #F36525;"><?= $arResult["PROPERTIES"]["OFFERS"]["VALUE"] = "PRESALE" ?></span>
