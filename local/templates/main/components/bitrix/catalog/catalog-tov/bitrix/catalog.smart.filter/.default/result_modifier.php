...
while($arFields = $res->Fetch())
{
    if($secFilter['IBLOCK_ID'] == 1) {
        if($arFields['PROPERTY_RAZDEL_MASAG_VALUE'] == $secFilter['SECTION_ID'] || $arFields['PROPERTY_RAZDEL_FITNES_VALUE'] == $secFilter['SECTION_ID'] || $arFields['PROPERTY_RAZDEL_DOM_VALUE'] == $secFilter['SECTION_ID'] || $arFields['PROPERTY_RAZDEL_RASPROD_VALUE'] == $secFilter['SECTION_ID'] || $arFields['PROPERTY_RAZDEL_TERAP_VALUE'] == $secFilter['SECTION_ID'] || $arFields['PROPERTY_RAZDEL_ZDOROV_VALUE'] == $secFilter['SECTION_ID']) {

            $arSelectN = Array("ID", "NAME", "PROPERTY_PROP_CODE");
            $arFilterN = Array("IBLOCK_ID"=>42, "ID"=>$arFields['ID'], "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y");
