    ...
    <div class="catpanel__wrapper">
        <div class="catpanel__top">
            ...
            <a href="#" class="catpanel__title">
                <?if(!empty($arResult["IPROPERTY_VALUES"]["SECTION_PAGE_TITLE"])):?><?=$arResult["IPROPERTY_VALUES"]["SECTION_PAGE_TITLE"]?><?else:?><?=$titleNew?><?endif;?>
        ...
        <div class="toppanel__sort-wp">
            ...
            <ul class="toppanel__sort-list" style="display: none;">
                <li class="toppanel__sort-item">
                    <?if($_GET['price']=='DESC') {?>
                        <a title="По убыванию" href="<?=$APPLICATION->GetCurPage();?>?price=ASC" class="toppanel__sort-link">
                            <img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortup.png">
                            Цена
                        </a>
                    <?} else {?>
                        <a title="По возрастанию" href="<?=$APPLICATION->GetCurPage();?>?price=DESC" class="toppanel__sort-link">
                ...
                <li class="toppanel__sort-item">
                    <?if($_GET['news']=='DESC') {?>
                        <a title="По возрастанию" href="<?=$APPLICATION->GetCurPage();?>?news=ASC" class="toppanel__sort-link">
                            <img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortdown.png">
                            Новизна
                        </a>
                    <?} else {?>
                        <a title="По убыванию" href="<?=$APPLICATION->GetCurPage();?>?news=DESC" class="toppanel__sort-link">
                            <img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortup.png">
                            Новизна
                        </a>
                    <?}?>
                ...
                <li class="toppanel__sort-item">
                    <?if($_GET['reiting']=='ASC') {?>
                        <a title="По возрастанию" href="<?=$APPLICATION->GetCurPage();?>?reiting=DESC" class="toppanel__sort-link">
                            <img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortdown.png">
                            Рейтинг
                        </a>
                    <?} else {?>
                        <a title="По убыванию" href="<?=$APPLICATION->GetCurPage();?>?reiting=ASC" class="toppanel__sort-link">
                            <img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortup.png">
                            Рейтинг
                        </a>
                    <?}?>
                ...
                <li class="toppanel__sort-item">
                    <?if($_GET['popular']=='DESC') {?>
                        <a title="По возрастанию" href="<?=$APPLICATION->GetCurPage();?>?popular=ASC" class="toppanel__sort-link">
                            <img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortdown.png">
                            Популярность
                        </a>
                    <?} else {?>
                        <a title="По убыванию" href="<?=$APPLICATION->GetCurPage();?>?popular=DESC" class="toppanel__sort-link">
                            <img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortup.png">
                            Популярность
                        </a>
                    <?}?>
...
<?/*$APPLICATION->IncludeComponent(
	...
	<div class="rightColumn">
        ...
        <div class="mob-hide">
		<h1><?if(!empty($arResult["IPROPERTY_VALUES"]["SECTION_PAGE_TITLE"])):?><?=$arResult["IPROPERTY_VALUES"]["SECTION_PAGE_TITLE"]?><?else:?><?=$titleNew?><?endif;?></h1>
            <div class="wp-hide">
                <?$APPLICATION->IncludeComponent(
                    "bitrix:catalog.section.list",
                    "relink_new",
	...
	$('#smartFilter').attr('top',$('.relink').outerHeight(true)); 
		...
		<div id="catalogLine">
			...
			?>
				...
				<div class="column">
					...
					<?if($_GET['price']=='DESC'):?><a title="По возрастанию" href="<?=$APPLICATION->GetCurPage();?>?price=ASC"><img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortup.png" /> По цене</a><?else:?>
					<a title="По убыванию" href="<?=$APPLICATION->GetCurPage();?>?price=DESC"><img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortdown.png" />По цене</a><?endif;?>
					
						<?if($_GET['reiting']=='ASC'):?>
						<a title="По убыванию" href="<?=$APPLICATION->GetCurPage();?>?reiting=DESC"><img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortdown.png" /> По рейтингу</a>
					<?else:?>
					<a title="По возрастанию" href="<?=$APPLICATION->GetCurPage();?>?reiting=ASC"><img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortup.png" />По рейтингу</a>
				<?endif;?>

                    <!-- По новизне -->
                    <?if($_GET['news']=='DESC') {?>
                        <a title="По возрастанию" href="<?=$APPLICATION->GetCurPage();?>?news=ASC"><img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortup.png" /> По новизне</a>
                    <?} else {?>
                        <a title="По убыванию" href="<?=$APPLICATION->GetCurPage();?>?news=DESC"><img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortdown.png" />По новизне</a>
                    <?}?>

                    <!-- По популярности -->
                    <?if($_GET['popular']=='DESC') {?>
                        <a title="По возрастанию" href="<?=$APPLICATION->GetCurPage();?>?popular=ASC" ><img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortup.png" /> По популярности</a>
                    <?} else {?>
                        <a title="По убыванию" href="<?=$APPLICATION->GetCurPage();?>?popular=DESC" ><img src="<?=SITE_TEMPLATE_PATH?>/images/new/sortdown.png" />По популярности</a>
                    <?}?>
        ...
        global $actionN;
        $arFilter = Array('IBLOCK_ID'=>22, 'ID'=>$arResult["VARIABLES"]["SECTION_ID"], 'GLOBAL_ACTIVE'=>'Y');
        $db_list = CIBlockSection::GetList(Array("timestamp_x"=>"DESC"), $arFilter, false, Array("UF_ACTIONS"));
        if($uf_value = $db_list->GetNext()) {
            $actionN=$uf_value["UF_ACTIONS"];
        }
        ...
        if($_GET['set_filter'] == "Y" && $_GET['arrFilter_1458_1576192816'] == "Y" && $_GET['arrFilter_1458_1335549163'] != "Y" && $_GET['arrFilter_1458_879349695'] != "Y") { // uno
            $actSortFilter = array("ID" => 3378);
        }
        if($_GET['set_filter'] == "Y" && $_GET['arrFilter_1458_1335549163'] == "Y" && $_GET['arrFilter_1458_1576192816'] != "Y" && $_GET['arrFilter_1458_879349695'] != "Y") { // 8 марта
            $actSortFilter = array("ID" => 3487);
        }
        if($_GET['set_filter'] == "Y" && $_GET['arrFilter_1458_879349695'] == "Y" && $_GET['arrFilter_1458_1576192816'] != "Y" && $_GET['arrFilter_1458_1335549163'] != "Y") { // 8 марта
            $actSortFilter = array("ID" => 7695);
        }

        if($_GET['set_filter'] == "Y" && $_GET['arrFilter_1458_1576192816'] == "Y" && $_GET['arrFilter_1458_1335549163'] == "Y" && $_GET['arrFilter_1458_879349695'] != "Y") { // 8 марта
            $actSortFilter = array("ID" => array(3378, 3487));
        }
        if($_GET['set_filter'] == "Y" && $_GET['arrFilter_1458_1576192816'] == "Y" && $_GET['arrFilter_1458_879349695'] == "Y" && $_GET['arrFilter_1458_1335549163'] != "Y") { // 8 марта
            $actSortFilter = array("ID" => array(3378, 7695));
        }
        if($_GET['set_filter'] == "Y" && $_GET['arrFilter_1458_879349695'] == "Y" && $_GET['arrFilter_1458_1335549163'] == "Y" && $_GET['arrFilter_1458_1576192816'] != "Y") { // 8 марта
            $actSortFilter = array("ID" => array(3487, 7695));
        }
