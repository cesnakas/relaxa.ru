...
<?if(!empty($arResult["SET_ITEMS"]["DEFAULT"])):?>
	<div id="set">
		<span class="heading"><?=GetMessage("SNT_HEADING")?></span>
			...
			<div class="setList">
				<div class="general setElement setMainElement changeID" data-price="<?=$arResult["ELEMENT"]["PRICE_DISCOUNT_VALUE"]?>" data-discount="<?=$arResult["ELEMENT"]["PRICE_DISCOUNT_DIFFERENCE_VALUE"]?>" data-id="<?=$arResult["ELEMENT"]["ID"]?>">
					<div class="wrap">
				...
				<div class="container">
					...
					<table id="setWindowTable">
						<tbody>
							<tr>
								<td class="wElement">
									<div id="wProduct" class="setElement setWindowElement changeID" data-price="<?=$arResult["ELEMENT"]["PRICE_DISCOUNT_VALUE"]?>" data-discount="<?=$arResult["ELEMENT"]["PRICE_DISCOUNT_DIFFERENCE_VALUE"]?>" data-id="<?=$arResult["ELEMENT"]["ID"]?>">
