...
foreach ($arResult["ITEMS"] as $index => $arElement):?>
    ...
    <div class="p-prods__item" id="<?=$this->GetEditAreaId($arElement["ID"]);?>">
        <?echo "<pre style='display: none'>"; print_r($arElement); echo "</pre>";?>
                        ...
                        <div class="p-prods__tag">
							...
							<?if(empty($arElement["PROPERTIES"]["STATUS_OUT"]["VALUE"])) {?>
								...
								<?} elseif($arElement["PROPERTIES"]["OFFERS"]["VALUE"] == "НА ЗАКАЗ") {?>
                                    <span class="p-prods__new" style="background-color: #780707; font-size: 10px !important;"><?= $arElement["PROPERTIES"]["OFFERS"]["VALUE"] ?></span>
								...
								<?} elseif($arElement["PROPERTIES"]["OFFERS"]["VALUE"] == "NY") {?>
                                    <span class="p-prods__new" style="font-size: 24px !important; position: absolute; background-color: transparent; color: transparent; background-image: url(/img/svg/ny30.svg); background-size: 54%; background-repeat: no-repeat; line-height: 0px !important; top: -2px; margin-top: 10px; height: 100px !important; -webkit-transform: rotate(45deg); -moz-transform: rotate(45deg); -ms-transform: rotate(45deg); -o-transform: rotate(45deg) !important; transform: rotate(45deg) !important;"><?= $arResult["PROPERTIES"]["OFFERS"]["VALUE"] ?></span>
