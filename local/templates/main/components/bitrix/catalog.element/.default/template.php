                    ...
                    <div class="slider_tovar">
                        ...
                        <div class="l_imgs no_adaptive">
                            ...
                            <div class="buttoms_slider_tovar">
                                <p id="rg_prev_slide"><img src="/bitrix/templates/dresscodeV2/img/slider_prev.png" alt=""></p>
                                <p id="rg_next_slide"><img src="/bitrix/templates/dresscodeV2/img/slider_next.png" alt=""></p>
                            </div>
                        </div>
                        <?if($arResult['PROPERTIES']['COLOR_SELECT']['VALUE']):?>
                            <div class="colors_tovar">
                                ...
                                <div class="color_list_tovar">
                                    <a href=""><img src="/bitrix/templates/dresscodeV2/img/tovar_color_1.jpg" alt=""></a>
                                    <a href=""><img src="/bitrix/templates/dresscodeV2/img/tovar_color_2.jpg" alt=""></a>
                                    <a href=""><img src="/bitrix/templates/dresscodeV2/img/tovar_color_3.jpg" alt=""></a>
                                    <a href=""><img src="/bitrix/templates/dresscodeV2/img/tovar_color_4.jpg" alt=""></a>
                                    <a href=""><img src="/bitrix/templates/dresscodeV2/img/tovar_color_5.jpg" alt=""></a>
                                    <a href=""><img src="/bitrix/templates/dresscodeV2/img/tovar_color_6.jpg" alt=""></a>
                                    <a href=""><img src="/bitrix/templates/dresscodeV2/img/tovar_color_7.jpg" alt=""></a>
                                    <a href=""><img src="/bitrix/templates/dresscodeV2/img/tovar_color_8.jpg" alt=""></a>
                                    <a href=""><img src="/bitrix/templates/dresscodeV2/img/tovar_color_9.jpg" alt=""></a>
                                </div>
                            </div>
                        <?endif;?>
                    </div>
...
<div class="title" style="color: #800000;"><?= $arResult['NAME'] ?></div>
                ...
                <? if (!empty($arResult["DETAIL_TEXT"])): ?>
                    <div id="detailText">
                        ...
                        <div class="ttext-ccolor"><div class="changeDescription"
                             data-first-value='<?= str_replace("'", "", $arResult["~DETAIL_TEXT"]) ?>'><?= $arResult["~DETAIL_TEXT"] ?></div></div>
                    </div>
                <? endif; ?>
...
<div id="<?= $this->GetEditAreaId($arResult["ID"]); ?>">
    ...
    <div style="display: none" id="catalogElement" class="item<? if (!empty($arResult["SKU_PRODUCT"])): ?> elementSku<? endif; ?>"
...
<div itemscope itemtype="http://schema.org/Product" class="microdata">
    ...
    <?php
    if (empty($arResult["PROPERTIES"]["RATING"]["VALUE"]) === false):
    ?>
