...
{
    $arPushImage["SMALL_IMAGE"] = array_change_key_case(CFile::ResizeImageGet($pictureID, array("width" => 138, "height" => 92), BX_RESIZE_IMAGE_PROPORTIONAL, false), CASE_UPPER);
...
if (!empty($arResult["PROPERTIES"]["RELATED_PRODUCT"]["VALUE"])) {
    ...
    $arSelect = Array("ID");
    $arFilter = Array( "ACTIVE" => "Y", "ID" => $arResult["PROPERTIES"]["RELATED_PRODUCT"]["VALUE"]);
...
/*echo "<pre>"; print_r($arResult['REVIEWS'][0]['RATE']); echo "</pre>";*/
$revRaiting = 0;
...
$arResult['OLD_RAITING'] = round($revRaiting / count($arResult['REVIEWS']));
  ...
  $ipropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues(
    ...
    $arResult["META DESCRIPTION"] = $ipropValues->getValues();