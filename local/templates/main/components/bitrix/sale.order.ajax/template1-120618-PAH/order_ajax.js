    ...
    BX.Sale.OrderAjaxComponent = {
        ...
        editPaySystemInfo: function(paySystemNode)
        {
            ...
            if (currentPaySystem)
            {
                ...
                {
                currentPaySystem.PRICE_FORMATTED = "Уточняйте";
                    price = BX.create('UL', {
...
console.log(currentDelivery);
                ...
                price = BX.create('LI', {
                    children: [
                        BX.create('DIV', {
                         ...
                         BX.create('DIV', {
                            props: {className: 'bx-soa-pp-list-description'},
                            html: "Дополнительно + 500 руб. для малогабаритных товаров <br/> Дополнительно + 1500 руб. для крупногабаритных грузов"
            ...
            if(currentDelivery.ID == 3 || currentDelivery.ID == 4) {     
...
console.log(event);
        ...
        editTotalBlock: function()
        {
            ...
            total.DEL_NAME = curDelivery.NAME;
            var namesam = 'Самовывоз';
            console.log(total);
            if (deliveryError)
            {
