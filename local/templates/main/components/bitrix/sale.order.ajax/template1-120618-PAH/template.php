		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-orderSave">
					...
					<a href="javascript:void(0)" style="margin: 10px 0" class="pull-right btn btn-default btn-lg hidden-xs final" data-save-button="true" onclick="sendGtag('Submit', 'Form', 'Buy'); sendYandex('Form_Submit_Buy', 'Macroconversion');">
						<?=$arParams['MESS_ORDER']?>
					</a>
				</div>
