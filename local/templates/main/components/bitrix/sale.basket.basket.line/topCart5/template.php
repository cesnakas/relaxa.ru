    ...
    <div class="cart_block">
        ...
        <div class="cart__icon__header">
            <?if (!empty($arResult["NUM_PRODUCTS"])){?>
                ...
                <a href="<?= SITE_DIR ?>personal/cart/"><img src="<?=SITE_TEMPLATE_PATH?>/images/ND/basket__header__icon.svg"></a>
            <?} else {?>
                <a href="<?= SITE_DIR ?>personal/cart/"><img src="<?=SITE_TEMPLATE_PATH?>/images/ND/basket__header__icon.svg">
				</a>
            <?}?>
        </div>
