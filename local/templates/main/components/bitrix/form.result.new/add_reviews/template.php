	...
	<div class="webFormMessage ololo" id="webFormMessage_<?=$arResult["arForm"]["ID"]?>">
		<div class="webFormMessageContainer">
			<div class="webFormMessageMiddle">
				<div class="webFormMessageHeading ololo">Ваш отзыв отправлен</div>
				<div class="webFormMessageDescription">Ваш отзыв успешно отправлен и в ближайшее время будет обработан модератором нашего сайта</div>
