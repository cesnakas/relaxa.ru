					...
					<?if($arResult["isFormNote"] != "Y"):?>
						...
						<?if($arResult["isFormDescription"] == "Y" || $arResult["isFormTitle"] == "Y" || $arResult["isFormImage"] == "Y"):?>
							<?if($arResult["isFormTitle"]):?>
								<div class="webFormModalHeading">Оставьте заявку и узнайте сумму персональной скидки на покупку нового кресла по программе обмена<a href="#" class="webFormModalHeadingExit"></a></div>
							<?endif;?>
						...
						<div class="webFormTools">
							<div class="tb">
								<div class="tc">
									<input <?=(intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : "");?> type="submit" name="web_form_submit" value="<?=htmlspecialcharsbx(strlen(trim($arResult["arForm"]["BUTTON"])) <= 0 ? GetMessage("FORM_ADD") : $arResult["arForm"]["BUTTON"]);?>" class="sendWebFormDw sendForm4" />
