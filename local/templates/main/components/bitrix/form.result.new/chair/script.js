$(function(){
	...
	$(document).on("submit", ".webFormDwModal.webFormModal-id-5 form", sendWebForm);

	$('input[name=form_text_229]').attr('placeholder', 'Введите имя');
	$('input[name=form_text_230]').attr('placeholder', '+7(___) ___-__-__');

	var phoneMask = new IMask(
	document.querySelector('[name="form_text_230"]'), {
