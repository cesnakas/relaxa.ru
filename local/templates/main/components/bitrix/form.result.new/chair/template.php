					...
					<?if($arResult["isFormNote"] != "Y"):?>
						...
						<?if($arResult["isFormDescription"] == "Y" || $arResult["isFormTitle"] == "Y" || $arResult["isFormImage"] == "Y"):?>
							<?if($arResult["isFormTitle"]):?>
								<div class="webFormModalHeading">Оставьте заявку на предзаказ кресла FUJIMO QI 2020 <br> и получите уникальную скидку<a href="#" class="webFormModalHeadingExit"></a></div>
							<?endif;?>
						...
						<div class="webform agree">
							<input type="checkbox" name="" id="f5agree" checked="checked" disabled="disabled">
							<span class="agree__info">Согласие на обработку персональных данных</span>
						</div>
						<div class="webFormTools">
							<div class="tb">
								<div class="tc">
									<input <?=(intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : "");?> type="submit" name="web_form_submit" value="<?=htmlspecialcharsbx(strlen(trim($arResult["arForm"]["BUTTON"])) <= 0 ? GetMessage("FORM_ADD") : $arResult["arForm"]["BUTTON"]);?>" class="sendWebFormDw sendForm5" />
