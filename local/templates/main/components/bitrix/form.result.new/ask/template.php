...
<div class="webFormDw" data-id="<?=$arResult["arForm"]["ID"]?>">
	...
	<?if($arResult["isFormNote"] != "Y"):?>
		...
		<?if($arResult["isFormDescription"] == "Y" || $arResult["isFormTitle"] == "Y" || $arResult["isFormImage"] == "Y"):?>
			<?if($arResult["isFormTitle"]):?>
				<div class="like-h2"><?=$arResult["FORM_TITLE"]?></div>
			<?endif;?>
		...
		<div class="webFormTools" style="text-align: center;">
	...
	<?endif;?>
	<div class="webFormMessage ololo" id="webFormMessage_<?=$arResult["arForm"]["ID"]?>">
		<div class="webFormMessageContainer">
			<div class="webFormMessageMiddle">
				<div class="webFormMessageHeading ololo">Ваш овопрос отправлен</div>
				<div class="webFormMessageDescription">Ваш вопрос успешно отправлен и в ближайшее время будет обработан модератором нашего сайта</div>
