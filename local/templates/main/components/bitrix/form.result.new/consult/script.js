$(function(){
	...
	$(document).on("submit", ".webFormDwModal.webFormModal-id-6 form", sendWebForm);

	$('input[name=form_text_231]').attr('placeholder', 'Введите имя');
	$('input[name=form_text_232]').attr('placeholder', '+7(___) ___-__-__');
	$('input[name=form_email_233]').attr('placeholder', 'example@email.ru');


    var phoneMask = new IMask(
    document.querySelector('[name="form_text_232"]'), {
