...
<?
$arParams['IBLOCK_ID'] = 4; // ID инфоблока
...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="news-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		...
		<?/*foreach($arItem["FIELDS"] as $code=>$value):?>
			<div class="show-prop">
			<? echo '<img src="https://relaxa.ru/bitrix/templates/dresscodeV2/components/bitrix/news/articles/images/svg/eye_icon.svg">' ?>&nbsp;<?=$value;?>
			</div><br />
		<?endforeach;*/?>
			<div class="show-prop">
			<? echo '<img src="/local/templates/main/components/bitrix/news/articles/images/svg/eye_icon.svg">' ?>&nbsp;
