...
$APPLICATION->SetPageProperty("title", "Видео и статьи | Интернет-магазин «RELAXA STAR»");
$APPLICATION->SetPageProperty("description" , "Видео и статьи интернет-магазина «RELAXA STAR». Как выбрать массажное кресло, какой массажер лучше, правила использования массажного оборудования читать онлайн.  ☎ Телефон: 8 (800) 333 00 51 ← Звоните прямо сейчас!");
