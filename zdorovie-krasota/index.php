...
$APPLICATION->SetPageProperty("tags", "Массажеры, массажные, аппараты, лица, тела, терапия, интернет-магазин, здоровье, красота, купить, заказать, недорого, цена, интернет-магазин, доставка, стоимость");
$APPLICATION->SetPageProperty("description", "Массажеры лица и тела купить недорого в интернет-магазине «RELAXA STAR». Огромный выбор качественных товаров для красоты, большая гарантия, бесплатная доставка, акции, скидки. ☎ Телефон: 8 (800) 333 00 51 ← Звоните прямо сейчас!");
$APPLICATION->SetPageProperty("keywords", "Массажеры, массажные, аппараты, лица, тела, терапия, интернет-магазин, здоровье, красота, купить, заказать, недорого, цена, интернет-магазин, доставка, стоимость");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FILTER_PROPERTY_CODE" => array(
			...
			1 => "ATT_BRAND",
			2 => "FUNKCIA_PROGREV",
			3 => "FUNKCIA_RASTYAZHKA",
			4 => "FUNKCIA_MULTIMEDIA",
			5 => "FUNKCIA_TIP_MASSAG_STOP",
			6 => "FUNKCIA_3D_4D",
			7 => "FUNKCIA_MASSAG_KOLENEI",
			8 => "VID_MASSAGA",
			9 => "TIP_MASSAGA_JAGODIC",
			10 => "MASSAG_SHEI",
			11 => "PROGREV",
			12 => "SKU_COLOR",
			13 => "VOLTAGE",
