...
var content = $('<div class="timepicker">\
				...
				<div class="chose-all">\
				<div class="handle">\
					<div class="cell-4"><a class="icon-up js-plus-houer"><i class="fas fa-plus"></i></a></div>\
					<div class="cell-2"></div>\
					<div class="cell-4"><a class="icon-up js-plus-minute"><i class="fas fa-plus"></i></a></div>\
				</div>\
				<div class="text">\
				...
				<div class="handle">\
					<div class="cell-4"><a class="icon-down js-minus-houer"><i class="fas fa-minus"></i></a></div>\
					<div class="cell-2"></div>\
					<div class="cell-4"><a class="icon-down js-minus-minute"><i class="fas fa-minus"></i></a></div>\
				</div>\
			</div>\
			...
			<div class="timepicker_picture">\
				<img src="/verstka/img/mobile/check_act.png" alt="" class="timepicker_img" onclick="$(\'.personal_reg__dropshipping\').click();">\
			</div>\
		</div>\
	</div>');
...
timepicker.bindEvent = function () {
	...
	// 选择分钟
		...
		thisTimePicker.title.text('Время');
	...
	thisTimePicker.hourShow.on('click',function() {
		...
		thisTimePicker.title.text('Часы');
	});
	...
	thisTimePicker.minuteShow.on('click',function() {
		...
		thisTimePicker.title.text('Минуты');
	});
};
