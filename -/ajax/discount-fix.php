...
$arIBlockProps = array(
    'SELECT_CHAIR' => $_POST['SELECT_CHAIR'],
    'PHONE' => $_POST['PHONE'],
...
if($ar_res = $res->GetNext()) {*/
    ...
    if ($RESULT_ID = CFormResult::Add(14, $arValues))
    {
        ...
        $comment = '';
        $comment .= 'Расцветка OTO TITAN: ' . $_POST['SELECT_CHAIR'] . PHP_EOL;		
        ...
        $roistatData = array(
            'roistat' =>'Зафиксировать скидку на OTO TITAN',
            ...
            'title'   => 'Зафиксировать скидку на OTO TITAN',
            'name'   => $_POST['NAME'],
            'phone' => $_POST["PHONE"],
            'comment' =>$comment,
            'fields'  => array(
			       "price" => 289000, // Поле бюджет в amoCRM
            )
        );
